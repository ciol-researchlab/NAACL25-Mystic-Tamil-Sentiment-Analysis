# -*- coding: utf-8 -*-
"""Arnab/tulu | NLP | Support | CIOL Winter ML BootCamp

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1g2pjxXfA-n71lsD0FT6Uo4AMGXRYGzmc
...
train_df = pd.read_csv("/content/Tulu_SA_train - Copy.csv")
train_df.head(3)

val_df = pd.read_csv("/content/Tulu_SA_val - Copy.csv")
val_df.head(3)

test_df = pd.read_csv("/content/Tulu_SA_test_without_label - Copy.csv")
test_df.head(3)
